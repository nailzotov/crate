...
public class TestStatementBuilder
{
    ...
    public void testArrayComparison() throws Exception {
        Expression anyExpression = SqlParser.createExpression("1 = ANY (1,2,3)");
        ...
        assertThat(arrayComparisonExpression.getRight(), instanceOf(InListExpression.class));

        Expression someExpression = SqlParser.createExpression("1 = SOME (1,2,3)");
        ...
        assertThat(someArrayComparison.getRight(), instanceOf(InListExpression.class));

        Expression allExpression = SqlParser.createExpression("'StringValue' = ALL (columnRef)");
        ...
        assertThat(allArrayComparison.getRight(), instanceOf(InListExpression.class));
    }
